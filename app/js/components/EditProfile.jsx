					...
					<form className="modal-content animate">
					    <div className="form-group form-padding">
						    <div className="modal-body form-group form-padding">
								...
								<input className="form-control" id="donorName" type="text" defaultValue={this.state.name}/>
								<label>Description</label>
								<input className="form-control" id="donorDescription" type="text" defaultValue={this.state.description}/>
							</div>
