...
export default class EditCoverPhoto extends React.Component {
	...
	render() {
		...
		return (
			<div>
				<button id="editCover" className="btn btn-info" onClick={this._buttonClick.bind(this)}>Edit Cover Photo</button>
				<div className={style}>
					<form method="post" action="/uploadCover" className="modal-content animate" encType="multipart/form-data" onSubmit={this._submit.bind(this)}>
					    <div className="form-group form-padding">
						    <div className="modal-body form-group form-padding">
								<label className="control-label">Upload New Cover Photo</label>
